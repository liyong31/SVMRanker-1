...
SVMRanker is a general framework for termination analysis of loop programs.
Our way to prove program termination is to synthesize ranking functions of programs.
Currently, SVMRanker utilizes SVM techniques to synthesize multiphase ranking functions for proving loop programs.
